...
import com.vendorapp.adapter.MainAdapter;
import com.vendorapp.model.FriendIDList;
import com.vendorapp.model.FriendList;
...
//                Toast.makeText(getActivity(), "error :(", Toast.LENGTH_SHORT).show();
    ...
    private void newPayment() {
        Intent intent = new Intent(this, com.vendorapp.PaymentActivity.class);
        startActivity(intent);
    }

    private void onLoginClicked() {
        Intent intent = new Intent(this, com.vendorapp.PersonActivity.class);
        startActivity(intent);
    }
    ...
    private void startStartUpActivity() {
        Intent intent = new Intent(this, com.vendorapp.LoginActivity.class);
        startActivity(intent);
    }
